        ...
        <div class="col-lg-8">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="title_banner" name="title_banner" placeholder="Input as a text">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="title2_banner" name="title2_banner" placeholder="Input as a text">
                    </div>
                </div>
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button name="submit_banner" type="submit" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </form>
